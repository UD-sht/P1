			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item">
					<a class="nav-link" data-widget="fullscreen" href="#" role="button">
						<i style="color:black;" class="fas fa-expand-arrows-alt"></i>
					</a>
				</li>
				<li class="nav-item dropdown">
					...
					<div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-3">
						<h4 class="h4 mb-0"><strong>{{ Auth::guard('citizen')->user()->name }}</strong></h4>
						<div class="mb-3">{{ Auth::guard('citizen')->user()->email }}</div>
						...
						<div class="dropdown-divider"></div>
						<a href="{{ route('citizen.logout') }}" class="dropdown-item text-danger">
